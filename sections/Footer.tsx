    ...
    return(
        <footer className={`bg-[#f6f6f6] py-14 px-10 lg:grid lg:grid-cols-4 lg:py-16 lg:px-40`}>
             ...
             <div className={`py-14 flex flex-col gap-6 lg:order-4 lg:py-0`}>
                  ...
                  <a href="mailto:taissacastello@gmail.com" className={`flex gap-3 text-base font-normal leading-snug text-[#3b3c4a] border border-[#bdbdbd] rounded-full w-[fit-content] px-5 py-3`}>Envio um email <img src={asset(`/carbon_send.svg`)} width={20}/></a>
             </div>
